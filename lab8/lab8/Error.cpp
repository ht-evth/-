...
static char err[MAX_AMOUNT_ERRORS][MAX_LEN_MSG] = {	"Ошибок нет",
												...
												"повторное описание идентификатора в одном блоке",
												"отсутствует описание идентификатора",
												"неверное использование вызова функции",
												"отсутствует описание функции",
												"не является функцией",
												"перегрузка функции (разные типы данных возвращаемых значений) - не ошибка",
												"повторное определение функции. Было удалено из дерева",
												"повторное объявление функции. удалено из дерева.",


	"отсутствует описание идентификатора",
	"идентификатор принадлежит функции"
...
void ErrorPrinter::print(int num_of_err, char* symbol, int num_of_line)
{
	...
	{
		std::cout << this->title << ": " << err[num_of_err] << " Неверный символ: " << symbol << "  В строке: " << num_of_line << std::endl;
...
{
		std::cout << this->title << ": " << err[num_of_err] << std::endl;
		ErrorPrinter::amount_errors++;
}
